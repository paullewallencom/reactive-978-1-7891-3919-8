...
import com.tomekl007.reactive.com.baeldung.rxjava.chapter_2.RandomRelayContainer;
...
public class SharingState {
    ...
    public void whenTwoObserversSubscribedToRandomRelay_thenOnlyOneReceivesEvent () {
        RandomRelayContainer randomRelayContainer = new RandomRelayContainer();
        TestObserver<Integer> firstObserver = TestObserver.create();
        TestObserver<Integer> secondObserver = TestObserver.create();
        randomRelayContainer.subscribe(firstObserver);
        randomRelayContainer.subscribe(secondObserver);
        randomRelayContainer.accept(5);
